...
export default function Contact() {
 ...
 <MapPin className="w-6 h-6 text-brand-gradient dark:text-white" />
 </div>
 <div>
 ...
 <div className="flex items-start gap-4">
 <div className="bg-zinc-100 dark:bg-zinc-900 p-4 rounded-xl border border-zinc-200 dark:border-transparent">
 <Phone className="w-6 h-6 text-brand-gradient dark:text-white" />
 </div>
 <div>
 ...
 <div className="flex items-start gap-4">
 <div className="bg-zinc-100 dark:bg-zinc-900 p-4 rounded-xl border border-zinc-200 dark:border-transparent">
 <Mail className="w-6 h-6 text-brand-gradient dark:text-white" />
 </div>
 <div>
 <h3 className="font-serif font-bold text-xl text-zinc-900 dark:text-brand-gradient">Email Us</h3>
 ...
 <div className="flex items-start gap-4">
 <div className="bg-zinc-100 dark:bg-zinc-900 p-4 rounded-xl border border-zinc-200 dark:border-transparent">
 <Clock className="w-6 h-6 text-brand-gradient dark:text-white" />
 </div>
 <div>
