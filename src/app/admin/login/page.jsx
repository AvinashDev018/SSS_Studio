...
export default function AdminLogin() {
 ...
 <Lock className="w-6 h-6 text-brand-gradient" />
 </div>
 ...
 className="w-full px-4 py-3 rounded-xl bg-zinc-900 border border-zinc-800 text-white focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-[#D4AF37] transition-colors"
 ...
 disabled={loading}
 suppressHydrationWarning
 className="w-full bg-brand-gradient hover-glow-brand hover:bg-[#c5a028] text-black font-bold py-3 px-4 rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
 >
