...
export default function CollageBuilder({ onAddToCart }) {
 ...
 photoFilter === f.value
 ? "bg-brand-gradient hover-glow-brand text-white shadow-md"
 ...
 ? "border-cyan-500 bg-cyan-50 dark:bg-brand-gradient hover-glow-brand text-white border-transparent/10"
 : "border-zinc-200 dark:border-zinc-800 hover:border-cyan-400/50"
 }`}
 >
 <div className="flex items-center gap-3">
 <LayoutGrid className={`w-5 h-5 ${selectedLayoutId === layout.id ? 'text-brand-gradient' : 'text-zinc-500'}`} />
 ...
 <p className="text-sm text-brand-gradient dark:text-brand-gradient font-medium">
 ...
 className="w-full bg-brand-gradient hover-glow-brand text-white border-transparent hover:bg-brand-gradient hover-glow-brand text-black py-4 rounded-2xl font-bold text-lg transition-colors flex items-center justify-center gap-2"
 >
