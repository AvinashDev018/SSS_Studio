...
export default function Footer() {
  return (
    <footer className="bg-[#080808] text-white border-t border-white/10 pt-16 pb-10 relative overflow-hidden">
      {/* Ambient background glow */}
      <div className="absolute top-0 right-1/4 w-96 h-96 bg-[#c5a880]/5 rounded-full blur-[140px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-14">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/[0.03] border border-white/10 text-[#c5a880] text-xs font-semibold uppercase tracking-wider mb-6">
              <ShieldCheck size={14} className="text-[#c5a880]" /> 1-Month Album Delivery Guaranteed
            </div>
            ...
            <div className="flex space-x-4">
              <a
                ...
                className="w-10 h-10 rounded-xl bg-white/5 hover:bg-[#c5a880]/20 border border-white/10 hover:border-[#c5a880]/40 flex items-center justify-center text-zinc-300 hover:text-[#c5a880] transition-colors"
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-xs font-semibold text-[#c5a880] tracking-widest uppercase mb-5">
              Explore
            </h3>
