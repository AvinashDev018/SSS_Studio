...
export default function SSSServices({ onOpenBooking }) {
  ...
  const services = SERVICES_DATA[currentLang] || SERVICES_DATA.en;
    ...
    <section id="services" className="py-24 bg-[#F9F9FB] relative overflow-hidden border-t border-black/5">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <div className="flex md:grid overflow-x-auto md:overflow-visible snap-x snap-mandatory no-scrollbar pb-6 gap-4 md:gap-8 -mx-4 px-4 md:mx-0 md:px-0 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div className="p-5 sm:p-6 text-center">
                      ...
                      <div className="mb-4">
                        <span className="font-serif text-lg font-extrabold text-[#b8860b] tracking-wider block">
                          {SERVICE_PRICES[service.id] || "Starting ₹ 5,000"}
                        </span>
                      ...
                      <div className="space-y-2 mb-2 text-left bg-[#FAF9F6] p-3 sm:p-3.5 rounded-xl border border-black/5">
                        {service.features.map((feat, fIdx) => (
                          <div key={`${service.id}-f-${fIdx}`} className="flex items-center gap-2 text-xs text-zinc-700 font-medium">
