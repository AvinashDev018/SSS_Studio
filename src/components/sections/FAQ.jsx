...
export default function FAQ() {
 ...
 <h2 className="font-serif text-4xl md:text-5xl font-bold mb-6 text-zinc-900 dark:text-transparent dark:bg-clip-text dark:bg-gradient-to-r dark:from-cyan-400 dark:to-violet-600 drop-shadow-sm">Frequently Asked Questions</h2>
 ...
 <ChevronDown 
 className={`w-5 h-5 text-brand-gradient transition-transform duration-300 flex-shrink-0 ${openIndex === index ? 'rotate-180' : ''}`} 
 />
 </button>
