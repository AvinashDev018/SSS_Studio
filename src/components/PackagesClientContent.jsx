...
export default function PackagesClientContent({ displayPackages }) {
  ...
  const [selectedPackageName, setSelectedPackageName] = useState("Wedding & Event Photo Shoot");

  const handleOpenBooking = (pkgName) => {
    setSelectedPackageName(pkgName || "Wedding & Event Photo Shoot");
            ...
            <AnimatedSection key={pkg.id || idx} delay={idx * 0.1}>
              ...
              >
                ...
                <button 
                  ...
                  className={`w-full text-center py-3.5 sm:py-4 rounded-xl text-sm sm:text-base font-extrabold transition-all duration-300 shadow-xl cursor-pointer ${
                    pkg.popular 
